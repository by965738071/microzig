...
pub fn read(mem: BlockMemory, offset: u32, data: []u8) ReadError!usize {
    const read_fn = mem.vtable.read_fn orelse return error.Unsupported;
    return read_fn(mem.ptr, offset, data);
}
// pub fn findSector(flash: BlockMemory, offset: u32) BaseError!u8 {

// }
pub fn sector_size(mem: BlockMemory, sector: u32) BaseError!u32 {
...
pub const TestDevice = struct {
    ...
    pub fn block_memory(td: *TestDevice) BlockMemory {
        return BlockMemory{ .vtable = vtable, .ptr = td };
    }
